...
public class AdminPage extends JFrame {
	...
	public AdminPage() {
		...
		JPanel lowerDataPanel = new JPanel();
		lowerDataPanel.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		lowerDataPanel.setBounds(12, 223, 1255, 412);
		contentPane.add(lowerDataPanel);
		
		table = new JTable();
		lowerDataPanel.add(table);
